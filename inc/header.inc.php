...
<nav class="navbar navbar-expand-md navbar-light bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?=  BASE_PATH; ?>"><img width="500" class="logo" src="assets/pictures/starisland.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="<?=  BASE_PATH; ?>">Home<span class="visually-hidden"></span>
                    </a>
                </li>
                <li class="nav-item">
